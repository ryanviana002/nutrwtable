...
<div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="Digite o nome do panificado" aria-label="Recipient's username" name="pesquisar" aria-describedby="button-addon2">
...
<?php
 ...
 $query = "SELECT * FROM panificados WHERE nome LIKE '%$pesquisar%' ORDER BY nome";
