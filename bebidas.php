...
<br><br>
<form method="POST" action="pbebidas.php">
<div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="Digite o nome da bebida" aria-label="Recipient's username" name="pesquisar" aria-describedby="button-addon2">
...
<?php
 $dados = $con->prepare("SELECT * FROM bebidas ORDER BY nome");
