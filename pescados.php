...
<br><br>
<form method="POST" action="ppescados.php">
<div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="Digite o nome do pescado" aria-label="Recipient's username" name="pesquisar" aria-describedby="button-addon2">
...
<?php
 $dados = $con->prepare("SELECT * FROM pescados ORDER BY nome");
