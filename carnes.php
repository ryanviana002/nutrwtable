...
<br><br>
<form method="POST" action="pcarnes.php">
<div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="Digite o nome da carne" aria-label="Recipient's username" name="pesquisar" aria-describedby="button-addon2">
...
<?php
 $dados = $con->prepare("SELECT * FROM carnes ORDER BY nome");
