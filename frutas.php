...
<br><br>
<form method="POST" action="pfrutas.php">
<div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="Digite o nome da fruta" aria-label="Recipient's username" name="pesquisar" aria-describedby="button-addon2">
...
<?php
 $dados = $con->prepare("SELECT * FROM frutas ORDER BY nome");
...
<?php/*
 ...
 $result_alimentos = ("SELECT * FROM frutas where nome like '%'.$pesquisar.'%' limit 5");
 $resultado_alimentos mysql_query($con, $result_alimentos);
 while($rows_alimentos = mysql_fetch_array($resultado_alimentos)){
     echo 
 }*/
?>
